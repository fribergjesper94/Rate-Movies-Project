...
public class DirectorServiceTest {
    ...
    void saveDirectorTest() {
        Director director1 = new Director(1, "Förnamn1", "Efternamn1", "Man");
    ...
    void getAllDirectorsTest() {
        Director director1 = new Director(1, "Förnamn1", "Efternamn1", "Man");
        Director director2 = new Director(2, "Förnamn2", "Efternamn2", "Kvinna");
        Director director3 = new Director(3, "Förnamn3", "Efternamn3", "Annat");
        DirectorService service = new DirectorService(mockRepository);
